          ...
          <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <div style={{ width: 6, height: 6, borderRadius: "50%", background: "#4f8fff", boxShadow: "0 0 8px rgba(79,143,255,0.5)", animation: "pulse 2s ease infinite" }} />
                <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, letterSpacing: 1.5, textTransform: "uppercase", color: "rgba(255,255,255,0.4)", fontWeight: 500 }}>
                  Deal Activity Map
                </span>
              </div>
              <span style={{ fontFamily: "'IBM Plex Mono', monospace", fontSize: 10, color: "rgba(255,255,255,0.2)" }}>
                {Object.keys(stateCounts).length} regions active
              </span>
            </div>

            <svg viewBox="0 0 960 500" style={{ width: "100%", height: "auto" }}>
              {/* Simplified US outline */}
              <path d="M 150 100 Q 200 80 300 90 Q 400 70 500 85 Q 600 75 700 90 Q 780 85 820 100 Q 840 130 850 180 Q 855 220 845 260 Q 830 300 810 340 Q 790 360 750 380 Q 700 400 650 390 Q 600 395 550 400 Q 500 410 450 405 Q 400 400 350 410 Q 300 420 250 400 Q 200 380 170 350 Q 150 320 140 280 Q 130 240 130 200 Q 135 150 150 100 Z"
                fill="rgba(79,143,255,0.03)" stroke="rgba(79,143,255,0.08)" strokeWidth="1.5" />

              {/* State grid lines for depth */}
              {[180, 300, 420, 540, 660, 780].map((x) => (
                <line key={`v${x}`} x1={x} y1={80} x2={x} y2={420} stroke="rgba(79,143,255,0.03)" strokeWidth="0.5" />
              ))}
              {[140, 200, 260, 320, 380].map((y) => (
                <line key={`h${y}`} x1={130} y1={y} x2={860} y2={y} stroke="rgba(79,143,255,0.03)" strokeWidth="0.5" />
              ))}

              {/* City coordinates for deal plotting */}
              {(() => {
                const cityCoords = {
                  // Midwest
                  "detroit": [683, 195], "grand rapids": [650, 185], "ann arbor": [673, 200],
                  "cleveland": [700, 200], "columbus": [695, 225], "cincinnati": [680, 240],
                  "chicago": [610, 195], "indianapolis": [640, 235], "milwaukee": [600, 180],
                  "madison": [590, 175], "minneapolis": [530, 155], "st. paul": [535, 155],
                  "st paul": [535, 155], "des moines": [530, 210], "cedar rapids": [550, 195],
                  "st. louis": [570, 260], "st louis": [570, 260], "kansas city": [510, 250],
                  "dayton": [690, 230], "akron": [705, 205], "toledo": [680, 195],
                  // Northeast
                  "new york": [790, 185], "boston": [820, 165], "philadelphia": [775, 200],
                  "pittsburgh": [730, 210], "baltimore": [760, 215], "washington": [755, 225],
                  // Southeast
                  "atlanta": [690, 310], "miami": [750, 410], "tampa": [725, 385],
                  "orlando": [735, 370], "charlotte": [735, 280], "raleigh": [750, 270],
                  "nashville": [650, 280], "memphis": [590, 290], "richmond": [755, 240],
                  "birmingham": [640, 310], "louisville": [660, 250], "jacksonville": [740, 350],
                  // Southwest
                  "dallas": [500, 330], "houston": [490, 370], "san antonio": [460, 370],
                  "austin": [475, 350], "phoenix": [280, 320], "denver": [350, 230],
                  "oklahoma city": [470, 290], "tulsa": [490, 270], "las vegas": [240, 260],
                  "salt lake city": [290, 210], "albuquerque": [320, 300],
                  // West
                  "los angeles": [195, 300], "san francisco": [165, 230], "san diego": [200, 320],
                  "san jose": [170, 245], "seattle": [190, 120], "portland": [185, 145],
                  "sacramento": [175, 220],
                  // Fallback for state names
                  "michigan": [665, 190], "ohio": [700, 215], "illinois": [615, 220],
                  "indiana": [645, 230], "wisconsin": [590, 175], "minnesota": [530, 155],
                  "iowa": [545, 205], "missouri": [555, 260], "california": [185, 265],
                  "texas": [475, 340], "florida": [735, 375], "new york": [790, 185],
                  "georgia": [700, 315], "colorado": [355, 240], "washington": [190, 125],
                  "massachusetts": [815, 170], "pennsylvania": [745, 200], "virginia": [745, 240],
                  "north carolina": [745, 270], "tennessee": [650, 275], "arizona": [285, 310],
                  "nevada": [235, 245], "oregon": [185, 150], "utah": [295, 235],
                  "connecticut": [800, 180], "maryland": [760, 215], "south carolina": [730, 295],
                  "alabama": [655, 320], "kentucky": [670, 255], "arkansas": [540, 295],
                  "mississippi": [600, 320], "louisiana": [555, 350], "oklahoma": [470, 285],
                  "kansas": [460, 250], "nebraska": [440, 210], "south dakota": [440, 170],
                  "north dakota": [440, 140], "montana": [330, 130], "wyoming": [340, 180],
                  "idaho": [260, 160], "new mexico": [330, 310], "maine": [835, 135],
                  "vermont": [800, 150], "new hampshire": [810, 155], "rhode island": [815, 180],
                  "delaware": [775, 210], "west virginia": [725, 235], "hawaii": [300, 420],
                  "alaska": [180, 420], "united states": [480, 250],
                };

                return deals.map((deal, i) => {
                  const geo = (deal.geo_match || "").toLowerCase();
                  // Try to match city first, then state
                  let coords = null;
                  for (const [place, xy] of Object.entries(cityCoords)) {
                    if (geo.includes(place)) { coords = xy; break; }
                  }
                  if (!coords) return null;

                  const sc = STATE_COLORS[stateFromGeo(deal.geo_match)] || "#4f8fff";
                  const size = deal.confidence >= 0.85 ? 6 : deal.confidence >= 0.7 ? 5 : 4;

                  return (
                    <g key={deal.id}>
                      {/* Pulse ring */}
                      <circle cx={coords[0]} cy={coords[1]} r={size * 3} fill="none" stroke={sc} strokeWidth="0.5" opacity="0">
                        <animate attributeName="r" from={size} to={size * 4} dur="2.5s" begin={`${i * 0.3}s`} repeatCount="indefinite" />
                        <animate attributeName="opacity" from="0.6" to="0" dur="2.5s" begin={`${i * 0.3}s`} repeatCount="indefinite" />
                      </circle>
                      {/* Glow */}
                      <circle cx={coords[0]} cy={coords[1]} r={size * 2} fill={sc} opacity="0.08" />
                      {/* Dot */}
                      <circle cx={coords[0]} cy={coords[1]} r={size} fill={sc}
                        style={{ filter: `drop-shadow(0 0 4px ${sc})` }}>
                        <animate attributeName="opacity" from="0" to="1" dur="0.5s" begin={`${i * 0.15}s`} fill="freeze" />
                      </circle>
                    </g>
                  );
                });
